...
public class JsonStreamReader {
	 ...
	 * indicates that the key name is parsed. The name/key value itself can
	 * be accessed using {@link #getString}
	 */
	KEY_NAME,
	/**
	 * Event for JSON string value. This event indicates a string value in
	 * an array or object is parsed. The string value itself can be accessed
	 * using {@link #getString}
	 */
	VALUE_STRING,
	/**
	 * Event for a number value. This event indicates a number value in an
	 * array or object is parsed. The number value itself can be accessed
	 * using {@link javax.json.JsonNumber} methods
	 */
	VALUE_NUMBER,
	/**
	 * Event for a true value. This event indicates a true value in an array
	 * or object is parsed.
	 */
	VALUE_TRUE,
	/**
	...
	VALUE_FALSE,
	/**
	 * Event for a null value. This event indicates a null value in an array
	 * or object is parsed.
	 */
	VALUE_NULL,
	/**
